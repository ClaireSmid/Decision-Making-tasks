...
BOXCOIN(1).coin = [DG.origin(1)-200 DG.origin(2)+250 DG.origin(1)-100 DG.origin(2)+350];
BOXCOIN(2).coin = [DG.origin(1)+100 DG.origin(2)+250 DG.origin(1)+200 DG.origin(2)+350];
